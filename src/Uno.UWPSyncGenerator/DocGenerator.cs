...
namespace Uno.UWPSyncGenerator
{
	...
	class DocGenerator : Generator
	{
		...
		public override void Build(string basePath, string baseName, string sourceAssembly)
		{
			...
			{
				_sb.AppendParagraph("The Uno.UI assembly includes all types and members from the WinUI 3.0 API. Only some of these are actually implemented. The remainder are marked with the `[NotImplemented]` attribute and will throw an exception at runtime if used.");
